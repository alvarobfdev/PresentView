...
class QuestionController extends Controller {
	...
	public function __construct()
	{
		...
		$this->modelview = new  \App\Models\Possibleanswers();
	...
	public function getIndex( Request $request )
	{
		...
		return view('question.index',$this->data);
	}	
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('app_questions'); 
		}
		$this->data['fields'] 		=  \SiteHelpers::fieldLang($this->info['config']['forms']);
		$this->data['subgrid'] = $this->detailview($this->modelview ,  $this->data['subgrid'] ,$id );
		$this->data['id'] = $id;
		return view('question.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		$this->data['id'] = $id;
		$this->data['access']		= $this->access;
		return view('question.view',$this->data);	
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			{
				$return = 'question/update/'.$id.'?return='.self::returnUrl();
			} else {
				$return = 'question?return='.self::returnUrl();
			}
			...
			return Redirect::to('question/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
